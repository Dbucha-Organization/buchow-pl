document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateHeroText(index) {
        ...
        // subtitleEl.textContent = "NAJLEPSZE: " + data.desc.split(':')[0];
        // We keep the main styling but change content if desired.
        // Actually, let's keep the main "ŚWIEŻE JEDNORAZÓWKI" as the H1 because it's strong SEO.
